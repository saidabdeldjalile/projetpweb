...
function searchRecipes() {
  // Récupérer toutes les boîtes de recettes
  const recipeBoxes = document.querySelectorAll('.box');

  // Récupérer le champ de recherche
  const searchInput = document.getElementById('searchInput');

  // Ajouter un événement de saisie à la zone de recherche
  searchInput.addEventListener('input', () => {
    const searchText = searchInput.value.toLowerCase();

    // Boucler à travers toutes les boîtes de recettes
    recipeBoxes.forEach(box => {
      // Récupérer le nom de la recette de la boîte
      const recipeName = box.querySelector('.name').textContent.toLowerCase();

      // Afficher ou masquer la boîte en fonction de si elle correspond au texte de recherche
...
let recetteID=localStorage.getItem('recetteID');
  function clickRecette1(){
    localStorage.setItem("recetteID",1);
  }
  function clickRecette2(){
    localStorage.setItem("recetteID",2);
  }
  function clickRecette3(){
    localStorage.setItem("recetteID",3);
  }
  function clickRecette4(){
    localStorage.setItem("recetteID",4);
  }
  function clickRecette5(){
    localStorage.setItem("recetteID",5);
  }
  function clickRecette6(){
    localStorage.setItem("recetteID",6);
  }
  function clickRecette7(){
    localStorage.setItem("recetteID",7);
  }
  function clickRecette8(){
    localStorage.setItem("recetteID",8);
  }
  function clickRecette9(){
    localStorage.setItem("recetteID",9);
  }
  function clickRecette10(){
    localStorage.setItem("recetteID",10);
  }

 


  document.getElementById("name1").innerHTML="Nom de la Recette: "+recettesDB[0].name;
document.getElementById("category1").innerHTML="Category: "+recettesDB[0].category;
document.getElementById("country1").innerHTML="Pays: "+recettesDB[0].country;
document.getElementById("duration1").innerHTML=" Duree: "+recettesDB[0].duration;

document.getElementById("name2").innerHTML="Nom de la Recette: "+recettesDB[1].name;
document.getElementById("category2").innerHTML=" Category: "+recettesDB[1].category;
document.getElementById("country2").innerHTML=" Pays: "+recettesDB[1].country;
document.getElementById("duration2").innerHTML="Duree: "+recettesDB[1].duration;

document.getElementById("name3").innerHTML="Nom de la Recette: "+recettesDB[2].name;
document.getElementById("category3").innerHTML=" Category: "+recettesDB[2].category;
document.getElementById("country3").innerHTML=" Pays: "+recettesDB[2].country;
document.getElementById("duration3").innerHTML="Duree: "+recettesDB[2].duration;


document.getElementById("name4").innerHTML="Nom de la Recette: "+recettesDB[3].name;
document.getElementById("category4").innerHTML=" Category: "+recettesDB[3].category;
document.getElementById("country4").innerHTML=" Pays: "+recettesDB[3].country;
document.getElementById("duration4").innerHTML="Duree: "+recettesDB[3].duration;
 
document.getElementById("name5").innerHTML="Nom de la Recette: "+recettesDB[4].name;
document.getElementById("category5").innerHTML=" Category: "+recettesDB[4].category;
document.getElementById("country5").innerHTML=" Pays: "+recettesDB[4].country;
document.getElementById("duration5").innerHTML="Duree: "+recettesDB[4].duration;
  
  
document.getElementById("name6").innerHTML="Nom de la Recette: "+recettesDB[5].name;
document.getElementById("category6").innerHTML=" Category: "+recettesDB[5].category;
document.getElementById("country6").innerHTML=" Pays: "+recettesDB[5].country;
document.getElementById("duration6").innerHTML="Duree: "+recettesDB[5].duration;
  

  
document.getElementById("name7").innerHTML="Nom de la Recette: "+recettesDB[6].name;
document.getElementById("category7").innerHTML=" Category: "+recettesDB[6].category;
document.getElementById("country7").innerHTML=" Pays: "+recettesDB[6].country;
document.getElementById("duration7").innerHTML="Duree: "+recettesDB[6].duration;
  
 

document.getElementById("name8").innerHTML="Nom de la Recette: "+recettesDB[7].name;
document.getElementById("category8").innerHTML=" Category: "+recettesDB[7].category;
document.getElementById("country8").innerHTML=" Pays: "+recettesDB[7].country;
document.getElementById("duration8").innerHTML="Duree: "+recettesDB[7].duration;
  
 
   
document.getElementById("name9").innerHTML="Nom de la Recette: "+recettesDB[8].name;
document.getElementById("category9").innerHTML=" Category: "+recettesDB[8].category;
document.getElementById("country9").innerHTML=" Pays: "+recettesDB[8].country;
document.getElementById("duration9").innerHTML="Duree: "+recettesDB[8].duration;
  

 
document.getElementById("name10").innerHTML="Nom de la Recette: "+recettesDB[9].name;
document.getElementById("category10").innerHTML=" Category: "+recettesDB[9].category;
document.getElementById("country10").innerHTML=" Pays: "+recettesDB[9].country;
document.getElementById("duration10").innerHTML="Duree: "+recettesDB[9].duration;
